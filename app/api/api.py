...
from app.api.endpoints import predict, ocr, ai_insight, calculate_budget, category_prediction, leak_and_financial_score

api_router = APIRouter()

api_router.include_router(leak_and_financial_score.router, tags=["financial score"])
